...
describe('Prueba la navegacion y Routing del header y footer',()=>{
    it('Prueba la nevegacion del header',()=>{
        cy.visit('/');
        ...
        //revisar que los enlaces de header sean correctos
    ...
    it('Pruebas navegacion del footer', ()=>{
        ...
        //revisar que los enlaces de footer sean correctos
        ...
        cy.get('[data-cy="copyRigth"]').should('have.prop', 'class').should('equal','copyright' );
