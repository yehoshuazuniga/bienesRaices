<main class="contenedor seccion">
    ...
    <?php if ($mensaje) : ?>
        <p data-cy="envio-formulario" class="alerta exito"><?php echo $mensaje; ?></p>
    ...
    <form data-cy="formulario-contacto" class="formulario" action="/contacto" method="POST">
        ...
        <fieldset>
            ...
            <div class="forma-contacto">
                ...
                <input type="radio" data-cy="forma-contacto" value="telefono" id="contactar-telefono" name="contacto[contacto]">

                <label for="contactar-email">E-mail</label>
                <input type="radio" data-cy="forma-contacto" value="email" id="contactar-email" name="contacto[contacto]">
            </div>
            <div id="contacto"></div>
